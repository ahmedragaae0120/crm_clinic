...
// in crm_clinic/test/data/data_source_impl/get_all_users_datasource_impl_test.dart.
...
class MockFirebaseManager extends _i1.Mock implements _i4.FirebaseManager {
  ...
  @override
  _i5.Future<_i2.UserCredential> signInWithFacebook() => (super.noSuchMethod(
        Invocation.method(
          #signInWithFacebook,
          [],
        ),
  ...
  _i5.Future<_i6.UserPermission> getUserPermission(String? uid) =>
      (super.noSuchMethod(
        ...
        returnValue:
            _i5.Future<_i6.UserPermission>.value(_i6.UserPermission.admin),
  ...
  @override
  _i5.Future<void> createDefaultAdminIfNotExists() => (super.noSuchMethod(
        Invocation.method(
